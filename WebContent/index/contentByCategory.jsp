				...
				<div class="filterbar">
					<ul class="filter-items list-inline">
						<s:if test='order=="default"'>
							<li class="active"><a
								href="/FlowerShopping/index/flowersByCategory.jsp?categoryId=<s:property value="categoryId"/>">综合</a></li>
						</s:if>
						<s:else>
							<li><a
								href="/FlowerShopping/index/flowersByCategory.jsp?categoryId=<s:property value="categoryId"/>">综合</a></li>
						...
						<s:if test='order=="id"'>
							<li class="active"><a
								href="/FlowerShopping/index/flowersByCategory.jsp?order=id&categoryId=<s:property value="categoryId"/>">最新</a></li>
						</s:if>
						<s:else>
							<li><a
								href="/FlowerShopping/index/flowersByCategory.jsp?order=id&categoryId=<s:property value="categoryId"/>">最新</a></li>
						...
						<s:if test='order=="price"'>
							<li class="active"><a
								href="/FlowerShopping/index/flowersByCategory.jsp?order=price&categoryId=<s:property value="categoryId"/>">价格</a></li>
						</s:if>
						<s:else>
							<li><a
								href="/FlowerShopping/index/flowersByCategory.jsp?order=price&categoryId=<s:property value="categoryId"/>">价格</a></li>
					...
					<ul class="pager">
						...
						<s:if test="goods.hasPrevious">
							<li><a
								href="/FlowerShopping/index/index.jsp?order=<s:property value="order"/>&categoryId=<s:property value="categoryId"/>&pageNo=<s:property value="goods.pageNo - 1"/>"><span
